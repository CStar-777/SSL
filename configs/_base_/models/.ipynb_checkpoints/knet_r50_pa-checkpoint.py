...
custom_imports = dict(
    imports=[
        'ssod.knet_pa.det.knet',
        'ssod.knet_pa.det.kernel_head',
        'ssod.knet_pa.det.kernel_iter_head',
        'ssod.knet_pa.det.kernel_update_head',
        'ssod.knet_pa.det.semantic_fpn_wrapper',
        'ssod.knet_pa.kernel_updator',
        'ssod.knet_pa.det.mask_hungarian_assigner',
        'ssod.knet_pa.det.mask_pseudo_sampler',
    ],
    allow_failed_imports=False)