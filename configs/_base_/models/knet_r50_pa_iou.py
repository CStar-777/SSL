...
custom_imports = dict(
    imports=[
        'ssod.knet_pa_iou.det.knet',
        'ssod.knet_pa_iou.det.kernel_head',
        'ssod.knet_pa_iou.det.kernel_iter_head',
        'ssod.knet_pa_iou.det.kernel_update_head',
        'ssod.knet_pa_iou.det.semantic_fpn_wrapper',
        'ssod.knet_pa_iou.kernel_updator',
        'ssod.knet_pa_iou.det.mask_hungarian_assigner',
        'ssod.knet_pa_iou.det.mask_pseudo_sampler',
    ],
    allow_failed_imports=False)