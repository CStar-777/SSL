...
custom_imports = dict(
    imports=[
        'ssod.knet_withiou_weight_cp.det.knet',
        'ssod.knet_withiou_weight_cp.det.kernel_head',
        'ssod.knet_withiou_weight_cp.det.kernel_iter_head',
        'ssod.knet_withiou_weight_cp.det.kernel_update_head',
        'ssod.knet_withiou_weight_cp.det.semantic_fpn_wrapper',
        'ssod.knet_withiou_weight_cp.kernel_updator',
        'ssod.knet_withiou_weight_cp.det.mask_hungarian_assigner',
        'ssod.knet_withiou_weight_cp.det.mask_pseudo_sampler',
    ],
